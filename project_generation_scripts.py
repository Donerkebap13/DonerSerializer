...
THIRDPARTY_PATH="{thirdparty_folder_path}"
...
def generate_scripts_for_platform(platform, generate_tests, xcode):
    ...
    generate_templated_file(generate_script_file_debug, generate_template, project_folder_path_debug, thirdparty_folder_path, cmake_call_debug)
    generate_templated_file(generate_script_file_release, generate_template, project_folder_path_release, thirdparty_folder_path, cmake_call_release)

    generate_templated_file(update_script_file_debug, update_template, project_folder_path_debug, thirdparty_folder_path, cmake_call_debug)
    generate_templated_file(update_script_file_release, update_template, project_folder_path_release, thirdparty_folder_path, cmake_call_release)
...
def generate_templated_file(script_file_path, template, project_folder_path, thirdparty_folder_path, cmake_call):
